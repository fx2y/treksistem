...
console.log('curl -H "Authorization: Bearer ' + MITRA_1_TOKEN + '" http://localhost:8787/api/mitra/services');
console.log('\n# Test 403 response with driver token:');
console.log('curl -H "Authorization: Bearer ' + DRIVER_1_TOKEN + '" http://localhost:8787/api/mitra/services');
console.log('\n# Create new service:');
console.log('curl -X POST -H "Authorization: Bearer ' + MITRA_1_TOKEN + '" -H "Content-Type: application/json" -d \'{"name":"Test Service","isPublic":true,"maxRangeKm":20,"supportedVehicleTypeIds":["vehicle_motor"],"supportedPayloadTypeIds":["payload_food"],"rate":{"baseFee":5000,"feePerKm":2000}}\' http://localhost:8787/api/mitra/services');