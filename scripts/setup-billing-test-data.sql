...
(1, 'pub_inv01', 'mitra02', 'PLATFORM_SUBSCRIPTION', 'pending', 100000, 'IDR', 'Monthly subscription', '00020101021226260014ID.DANA.WWW011893600009152408240301740204740602051570030303IDR520454005802ID5914Toko Roti Enak6007Jakarta6105123456105170613INV_PLATFORM640400006304', strftime('%s', 'now', '+30 days') * 1000, strftime('%s', 'now') * 1000),
(2, 'pub_inv02', 'mitra02', 'CUSTOMER_PAYMENT', 'paid', 50000, 'IDR', 'Customer order payment', NULL, NULL, strftime('%s', 'now') * 1000),
(3, 'pub_inv03', 'mitra02', 'PLATFORM_SUBSCRIPTION', 'pending', 100000, 'IDR', 'Monthly subscription', '00020101021226260014ID.DANA.WWW011893600009152408240301740204740602051570030303IDR520454005802ID5914Toko Roti Enak6007Jakarta6105123456105170613INV_PLATFORM640400006304', strftime('%s', 'now', '+30 days') * 1000, strftime('%s', 'now') * 1000),
(4, 'pub_cust_inv01', 'mitra02', 'CUSTOMER_PAYMENT', 'pending', 25000, 'IDR', 'Ongkir Roti', '00020101021226260014ID.DANA.WWW011893600009152408240301740204740602051570030303IDR520454005802ID5914Toko Roti Enak6007Jakarta6105123456105170613ONGKIR_ROTI6403001063045FAC', NULL, strftime('%s', 'now') * 1000);